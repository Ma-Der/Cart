...
var Cart = /*#__PURE__*/function () {
  function Cart() {
    ...
    if (Object.keys(discountCodes).find(function (key) {
      return discountCode === key;
    })) {
      Object.keys(discountCodes).some(function (key) {
        if (discountCode === key) {
          _this.discount = discountCodes[key];
        }
      });
  ...
  _createClass(Cart, [{
    key: "addItem",
    value: function addItem(cartItem, amount) {
    ...
    value: function deleteItem(cartItem) {
      ...
      var result = this.cartList.filter(function (item) {
        return item.id !== cartItem.id ? item : null;
      });
      this.cartList = result;
    }
  }, {
    key: "changeItemAmount",
    value: function changeItemAmount(cartItem, amount) {
      _Validation__WEBPACK_IMPORTED_MODULE_0__.Validation.validateCartItem(cartItem);
      _Validation__WEBPACK_IMPORTED_MODULE_0__.Validation.validateAmount(amount);
      var result = this.cartList.filter(function (item) {
    ...
    value: function cartSummary() {
      ...
      var result = this.cartList.map(function (item) {
        return item.price * item.amount - item.price * item.amount * (_this2.discount / 100);
    ...
    value: function showCart() {
      console.log("\n        Cart:\n            ".concat(this.cartList.map(function (item, index) {
...
var CartItem = /*#__PURE__*/function () {
  function CartItem(name, category, price) {
...
var Validation = /*#__PURE__*/function () {
  ...
  _createClass(Validation, null, [{
    key: "validateCartItem",
    value: function validateCartItem(item) {
